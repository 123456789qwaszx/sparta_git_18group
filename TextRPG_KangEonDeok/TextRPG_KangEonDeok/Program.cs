            ...
            do
            {
                if (int.TryParse(Console.ReadLine(), out int output) && output >= 0 && output <= StoreItem.Count)
                {
                    ...
                    else
                    {
                            ...
                            StoreItem.Add(ax);
                        Inventory.Remove(ax);
                            player.Money = 1300;//(StoreItem[i].Price);
                            ProcessTown();
                            //SellItem();
                        }
                }
...
//public void SetInfo(int hp, int attack, int armor)
//{
//    this.hp = hp;
//    this.attack = attack;
//    this.armor = armor;
...
/*
    List<int> list = new List<int>();
            ...
            foreach (int num in list)
                ...
                class Item
        {
            public item(ind id) { this.id = id}
            public int id;
        }

        Dictionary<int, item> dic = new Dictionary<int, Monster>();
...
//Console.WriteLine($" 1. {itemlist[1]}");
//Console.WriteLine($" 2. {itemlist[2]}");
//Console.WriteLine($" 3. {itemlist[3]}");
//Console.WriteLine($" 4. {itemlist[4]}");
//Console.WriteLine($" 5. {itemlist[5]}");
//Console.WriteLine($" 6. {itemlist[6]}");

//int[] inventory = new int[10] { Item item };
//inventory[0] = 10;
